...
const Icons: Icons = {
  ...
  coachingIcon: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path d="M.75,23.25H5.571a1.966,1.966,0,0,0,1.929-2v-2a1.966,1.966,0,0,0-1.929-2H.75" />
      <path d="M5.641,23.25H21.75a1.5,1.5,0,0,0,1.5-1.5v-3a1.5,1.5,0,0,0-1.5-1.5H5.641" />
      <line x1="20.25" y1="17.25" x2="20.25" y2="23.25" />
      <line x1="17.25" y1="17.25" x2="17.25" y2="23.25" />
      <line x1="14.25" y1="17.25" x2="14.25" y2="23.25" />
      <line x1="11.25" y1="17.25" x2="11.25" y2="23.25" />
      <line x1="4.5" y1="20.25" x2="0.75" y2="20.25" />
      <path d="M16.2,17.25V16a.549.549,0,0,0-.388-.513A3.743,3.743,0,0,1,13.2,11.75c0-3.789,4.651.945,4.8-10.435A.586.586,0,0,0,17.4.75H6.6a.586.586,0,0,0-.6.565c.148,11.38,4.8,6.646,4.8,10.435a3.743,3.743,0,0,1-2.614,3.741A.548.548,0,0,0,7.8,16V17.25Z" />
      <path d="M6.023,2.25H3.55A.536.536,0,0,0,3,2.826c.131,1.379.774,4.752,3.925,4.673" />
      <path d="M17.977,2.25h2.542a.535.535,0,0,1,.547.576c-.132,1.389-.783,4.8-3.992,4.67" />
    </svg>
  ),
  habits: (
  ...
  coaching: (
    <g>
      <path d="M11.968,12.61A5.873,5.873,0,0,0,6.75,9a6,6,0,0,0-6,5.25" />
      <path d="M3.375 4.124 A3.375 3.375 0 1 0 10.125 4.124 A3.375 3.375 0 1 0 3.375 4.124 Z" />
      <path d="M13.875 3.374 A2.625 2.625 0 1 0 19.125 3.374 A2.625 2.625 0 1 0 13.875 3.374 Z" />
      <path d="M20.4,9a4.5,4.5,0,0,0-7.284-.709" />
      <path d="M16.5 14.307L9.75 17.087 16.5 19.557 23.25 17.087 16.5 14.307z" />
      <path d="M9.75 17.065L9.75 20.837" />
      <path d="M12.75,18.185V21.3a.75.75,0,0,0,.471.7l3,1.2a.755.755,0,0,0,.557,0l3-1.2a.751.751,0,0,0,.472-.7V18.185" />
    </g>
  ),
  sun: (
    <g>
  ...
  analyticsIcon: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <path d="M6,17.25H3a.75.75,0,0,0-.75.75v5.25h4.5V18A.75.75,0,0,0,6,17.25Z" />
      <path d="M13.5,9.75h-3a.75.75,0,0,0-.75.75V23.25h4.5V10.5A.75.75,0,0,0,13.5,9.75Z" />
      <path d="M21,14.25H18a.75.75,0,0,0-.75.75v8.25h4.5V15A.75.75,0,0,0,21,14.25Z" />
